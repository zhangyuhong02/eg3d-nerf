...
def extract_audio_features(path, mode='wav2vec'):
    ...
    if mode == 'wav2vec':
        ...
        cmd = f'python /home/zyh/eg3d-main/eg3d/data_util/deepspeech_features/extract_ds_features.py --input {path}'
    os.system(cmd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--subject', type=str, default='Obama', help="")
    ...
    if opt.task == -1 or opt.task == 3:
        extract_images(opt.video_path, out_path=ori_imgs_dir)
